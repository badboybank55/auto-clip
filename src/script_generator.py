...
WORDS_PER_SECOND = 1.1   # Thai ElevenLabs TTS measured ~8-9 sec/sentence
...
_FRAMEWORK_PACING = {
    # เป้าหมาย 50-60 วินาที = 6-8 ประโยค (Thai TTS ~8-9 วิ/ประโยค, YouTube Shorts ≤60วิ)
    "story":        "6-7 ประโยค (เล่าช้า มี arc — เป้า 50-55 วิ)",
    "confession":   "6-7 ประโยค (กระชับ confession — เป้า 50-55 วิ)",
    "before_after": "7-8 ประโยค (before 2 + transition + after 2 + payoff + CTA)",
    "countdown":    "ขึ้นกับจำนวนอันดับ — แต่ละอันดับ 1 ประโยคกระชับ ครบทุกอันดับ เป้า ≤ 60 วิ",
    "what_if":      "6-7 ประโยค (scenario กระชับ — เป้า 50-55 วิ)",
    "myth":         "7-8 ประโยค (2-3 ความเชื่อ × 2 ประโยค + payoff + CTA — เป้า 55-60 วิ)",
    "deep_dive":    "7-8 ประโยค (เจาะลึกแต่กระชับ — เป้า 55-60 วิ)",
    "list":         "ขึ้นกับจำนวนข้อ — แต่ละข้อ 1 ประโยคกระชับ ครบทุกข้อ เป้า ≤ 60 วิ",
    "comparison":   "7-8 ประโยค (A 2 + transition + B 2 + verdict + CTA — เป้า 55-60 วิ)",
    "betrayal":     "7-8 ประโยค (reveal + HOW 2 + cliffhanger + เฉลย 2 + CTA)",
}
...
- เนื้อหาการเงิน: เขียนในเชิง "ให้ข้อมูล/ความรู้" เท่านั้น ห้ามใช้ภาษาแนะนำโดยตรง เช่น "คุณควรซื้อ X" / "ลงทุนใน Y ทันที" — ให้ใช้ "ผู้เชี่ยวชาญมองว่า..." / "ข้อมูลที่ควรรู้คือ..." / "คนส่วนใหญ่เลือก..." แทน
- ประโยคสุดท้ายของสคริปต์ต้องเป็น: "เนื้อหานี้เป็นข้อมูลเพื่อการศึกษาเท่านั้น ไม่ใช่คำแนะนำทางการเงิน"
...
กฎแต่ละ platform:
TikTok — ≤150 ตัวอักษร เริ่มด้วย keyword ไม่ใช่ emoji | hashtags 5 อัน เน้น relevance สูงสุด | จบด้วยคำถาม specific
Instagram Reels — 3-4 ประโยค personal | hashtags 5 อัน เน้น relevance สูงสุด | จบด้วย "💾 save ไว้ก่อนเลย"
Facebook — 4-5 ประโยค conversational | hashtags 5 อัน เน้น relevance สูงสุด | จบด้วยคำถามกระตุ้น comment
YouTube — title SEO ≤60 ตัวอักษร | description 2-3 ประโยค | tags 5 อัน เน้น relevance สูงสุด | ใส่ #Shorts
